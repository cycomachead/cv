...
% Color setup matches latex/main.tex so both documents render with identical Berkeley
...
% NB: do not load fontawesome5 here — moderncv's icon setup loads
% fontawesome6, which errors if v5 is already present. No \fa* commands
% are used directly in this document anyway.
\usepackage{fontspec}
...
\begin{document}
    ...
    \item Faculty Director/Co-Director, EECS Summer Instruction (2022--2026): oversee $\sim$10 courses and a \$100--250K operating budget per session, including hiring, payroll, and curriculum approval
    \item Principal/co-investigator on \$200K+ in instructional-technology and open-source infrastructure grants funding accessibility, autograding, curriculum modernization, and Snap\textit{!}Cloud operations
    \item Member, Undergraduate Study Committee (2019--2025); Student Grievances Committee (2020--2023)
    \end{itemize}}
    ...
    Co-architect of the open-source cloud platform powering this blocks-based visual programming language used by 1M+ educators and students worldwide; system serves 10M+ stored projects. Contribute to the core JavaScript IDE and own project-storage, sharing, and authentication services.
    }
    ...
    \cventry{2011--2015}{B.A. Computer Science}{UC Berkeley, College of Letters \& Science}{}{}{}
