...
\begin{itemize}
    ...
    % \href{https://faberllull.cat/en/residencia.cfm?id=42597\&url=educational-programming-and-robotics-vi.htm}{(Open page)}}

    \item{Faberlull: Educational Programming Languages and Robotics VI, Invited Resident
    \newline
    May 4-11, 2023, Olot, Spain \href{https://faberllull.cat/en/residencia.cfm?id=42597\&url=educational-programming-and-robotics-vi.htm}{(Open page)}}
